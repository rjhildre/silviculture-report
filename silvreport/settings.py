"""
Django settings for silvreport project.
...
""" ('Eric Aubert', 'eric.aubert@dnr.wa.gov'),
    ...
    ('Chris Snyder', 'chris.snyder@dnr.wa.gov'), """
...
WSGI_APPLICATION = 'silvreport.wsgi.application'
...
STATIC_ROOT = os.path.abspath(os.path.join(BASE_DIR, 'silvreport', 'static'))
STATIC_URL = '/static/'
